 ...
 * Example file
 *
 * Authenticating the end-user with a specific Quality of Authentication (QoA),
 * using two-factor authentication, which, if not available, automatically guides
 * the end-user in attaining that QoA
 *
 *
...
try {
    ...
    $claims = null;
    $qoa = 'qoa2'; // Request the required Quality of Authentication (QoA), qoa2
    $qor = null;
